      ...
      <section className="py-12 sm:py-16 px-4 sm:px-8 bg-white">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-12 bg-white rounded-xl shadow-lg p-6 sm:p-8">
          ...
          <div className="text-center md:text-left">
            ...
            <button onClick={scrollToSuggestions} className="bg-[rgba(173,21,24,1)] hover:bg-red-700 text-white font-semibold px-5 sm:px-6 py-2.5 sm:py-3 rounded-full transition-colors lg:px-24 mt-4">
              Share Your Ideas
            </button>
          </div>
        </div>
