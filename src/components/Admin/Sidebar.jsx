...
import { FiHome, FiUsers, FiUpload, FiBox, FiShoppingCart, FiSettings, FiFileText, FiTag, FiMail, FiGlobe, FiImage, FiLayers } from 'react-icons/fi'
...
const links = [
  ...
  { to: '/admin/pages', label: 'Pages CMS', icon: FiFileText },
